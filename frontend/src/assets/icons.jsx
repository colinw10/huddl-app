 ...
 * All icons accept: size (number), className (string), and any SVG props.
 * 
 * Usage:
 *   import { HeartIcon, UserIcon } from '../../assets/icons';
 *   <HeartIcon size={18} className="like-icon" />
 */
...
/** Logout door with arrow - used for Logout */
...
/** Login door with arrow - used for Login */
...
/** Heart outline - used for Like (not liked) */
...
/** Heart filled - used for Like (liked state) */
export const HeartFilledIcon = ({ size = 18, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Comment bubble - used for Reply/Comment */
export const CommentIcon = ({ size = 18, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Share/forward arrow - used for Share */
export const ShareIcon = ({ size = 18, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Bookmark outline - used for Save */
export const BookmarkIcon = ({ size = 18, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Settings gear - used for Settings */
...
/** Back arrow - used for Return/Back navigation */
...
// ============================================
// PROFILE & LOCATION ICONS
// ============================================

/** Map pin for location */
export const LocationIcon = ({ size = 14, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Back arrow with gradient for Login/Signup */
export const BackArrowGradientIcon = ({ size = 32, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Flag for milestone */
export const FlagIcon = ({ size = 18, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const StarIcon = ({ size = 16, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
