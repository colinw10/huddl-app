...
function Home() {
  ...
  const mockPosts = [
    ...
    },
    {
      ...
      content: "Finally completed my first marathon! 26.2 miles of pure determination.",
      timestamp: "3h",
    ...
    },
    {
      ...
      author: "Tito",
      userId: "tito",
      content: "Yoga session at sunset was exactly what I needed today.",
      timestamp: "10h",
    ...
    },
    {
      ...
      author: "Crystal Ruiz",
      userId: "crystal_ruiz",
      content: "Finally hit my goal of running a sub-20 minute 5K!",
      timestamp: "1d",
    ...
    },
    {
      ...
      author: "Alex Rivera",
      userId: "alex_rivera",
      content: "New setup finally complete. Dual monitors hit different.",
      timestamp: "5h",
    ...
    },
    {
      ...
      author: "Alex Rivera",
      userId: "alex_rivera",
      content: "Just got my AWS certification! Cloud architect mode activated.",
      timestamp: "5h",
